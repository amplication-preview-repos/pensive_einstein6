...
@InputType()
class SubmissionCreateNestedManyWithoutAssignmentsInput {
...
export { SubmissionCreateNestedManyWithoutAssignmentsInput as SubmissionCreateNestedManyWithoutAssignmentsInput };
